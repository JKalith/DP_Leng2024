...
<svg xmlns="http://www.w3.org/2000/svg" width="40" height="30"      viewBox="2 4 20 20"   fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-home">
  ...
  <NavLink href="/activity/manageActivity" exact className={styles.navLinks}>
  ...
  <NavLink href="/users" exact className={styles.navLinks+" "+styles.valueAcount}>
  <button className={ styles.value }>
